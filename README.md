...
Examples of how to use the library from powershell, blazor or any other client can be seen in the [PSCardRage repoistory](https://github.com/mvit777/teams-card-cmdlet)
